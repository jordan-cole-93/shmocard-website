...
const HERO_PRODUCT_TILES = [
  { name: "CR-80 Card",  price: 12, img: "assets/products/card-cr80.jpg" },
  { name: "L-Sign",      price: 28, img: "assets/products/card-lsign.jpg" },
  { name: "Square Disc", price: 9,  img: "assets/products/card-square.jpg" },
];
...
function HeroStage({ kind = "crew" }) {
  ...
  return (
    <div className={`home-hero__stage home-hero__stage--${kind}`}>
      <img
        src="assets/mascot/hero-crew.png"
