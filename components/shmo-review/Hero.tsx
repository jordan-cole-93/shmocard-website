...
// custom padding, and centered flex layout. We render the <section>
// directly and emit the wave as a sibling per this repo's convention.
//
// Server component.
    ...
    <>
      <section className="review-hero" aria-label="Shmo Review hero">
        <div className="shm-container review-hero__inner">
          ...
          <div className="review-hero__strip" aria-label="Hero photo placeholder">
            <span className="review-hero__strip-label">
              Wide hero photo — three CR-80 cards on a counter
            </span>
          </div>
        </div>
      </section>
      <div className="shm-wave shm-wave--graham" aria-hidden="true" />
    </>
  );
}
