          ...
          <div className="home-hero__grid">
            <div>
              <div className="home-hero__copy">
                ...
                {/* AVATAR TRUST STACK — generated via Magic MCP builder, adapted */}
                <motion.div className="hero-avatar-stack" {...fadeUp(0.2)}>
                  ...
                  <div className="hero-avatar-stack__copy">
                    ...
                    <p className="hero-avatar-stack__text">
                      Loved by{" "}
                      <strong>Carly</strong>, <strong>Marshall</strong>, and{" "}
                      <em>500+</em> Main Street crews
                    </p>
                  </div>
                </motion.div>

                <motion.div className="home-hero__meta" {...fadeUp(0.25)}>
